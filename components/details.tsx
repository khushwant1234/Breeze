...
const rawData = [
  ...
  { key: 8, img: "/Anubhav Kansal.DNG", title: "Public Relations Lead", name: "Anubhav Kansal", year: "2028" },
  { key: 9, img: "/Nithya.heif", title: "Public Relations Lead", name: "Nithya Pasupuleti", year: "2027" },
  ...
  { key: 12, img: "/shrijitha.jpeg", title: "Design Lead", name: "Shrijita Guha", year: "2028" },
  { key: 13, img: "/design2.png", title: "Design Lead", name: "Shaivi Dhandapani", year: "2028" },
  { key: 14, img: "/tanya.jpeg", title: "UI/UX Design Lead", name: "Tanya Edlyn", year: "2026" },
  { key: 15, img: "/Kovid_Bhardwaj.jpg", title: "Content Lead", name: "Kovind Bhardwaj", year: "2027" },
  { key: 16, img: "/Aviral.jpg", title: "Content Lead", name: "Aviral Mishra", year: "2027" },
  { key: 17, img: "/vidhushi.jpg", title: "Decor Lead", name: "Vidhushi Prateek", year: "202X" },
  { key: 18, img: "/Jahnavi.HEIC", title: "Decor Lead", name: "Jahnavi Verma", year: "2028" },
  { key: 19, img: "/404-image.png", title: "Web Development Lead", name: "Khushwant Singh", year: "2027" },
  ...
  { key: 23, img: "/ArshBhasin.jpg", title: "Event Management Lead", name: "Arsh Bhasin", year: "202X" },
  { key: 24, img: "/yashika.jpg", title: "Event Management Lead", name: "Yashika Gupta", year: "2027" },
  { key: 25, img: "/Arnav Aggarwal.jpg", title: "Event Management Lead", name: "Arnav Aggarwal", year: "2027" },
  { key: 26, img: "/Jaideep.JPG", title: "Production Lead", name: "Jaideep K", year: "2026" },
  { key: 27, img: "/Kushagr.HEIC", title: "Informal Games Lead", name: "Kushagr Saigal", year: "2028" },
  { key: 28, img: "/Shivaank Garg.HEIC", title: "Informal Games Lead", name: "Shivaank Garg", year: "2028" },
  { key: 29, img: "/Ayushi.jpg", title: "Transportation Lead", name: "Ayushi", year: "202X" },
  { key: 30, img: "/YATHARTH.jpg", title: "Security Lead", name: "Yatharth Mittal", year: "202X" },
  { key: 31, img: "/Tabitha.jpg", title: "Security Lead", name: "Tabitha Williems", year: "202X" },
  { key: 32, img: "/TANISHKA.jpeg", title: "Hospitality Lead", name: "Tanishka Jain", year: "202X" },
  { key: 33, img: "/Vignesh.HEIC", title: "Hospitality Lead", name: "Vignesh A", year: "2028" },
  { key: 34, img: "/rahul.jpeg", title: "Accommodation Lead", name: "Rahul Rathnavel", year: "202X" },
